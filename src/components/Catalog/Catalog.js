        ...
        <div className="row">
            ...
            <section className="catalog">
                ...
                <li className="nav-item">
                    <NavLink className="nav-link active" href="#">Все</NavLink>
                </li>
                <li className="nav-item">
                    <NavLink className="nav-link" href="#">Женская обувь</NavLink>
                </li>
                <li className="nav-item">
                    <NavLink className="nav-link" href="#">Мужская обувь</NavLink>
                </li>
                <li className="nav-item">
                    <NavLink className="nav-link" href="#">Обувь унисекс</NavLink>
                </li>
                <li className="nav-item">
                    <NavLink className="nav-link" href="#">Детская обувь</NavLink>
                </li>
                </ul>
                <div className="row">
                <div className="col-4">
